  ...
  return (
    <Container>
      ...
      <ContentMeta>
        ...
        <SubTitle>{"2021 • 1 Season • Docuseries, Anthology"}</SubTitle>
        <Description>{"ASSEMBLED is an immersive series of documentary-style specials examining the creation of Marvel Studios’ thrilling new shows and theatrical releases."}</Description>
      </ContentMeta>
    </Container>
  );
};
